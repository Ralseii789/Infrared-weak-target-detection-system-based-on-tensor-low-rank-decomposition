...
#数据集分割工具
# ==== 设置路径 ====
voc_root = 'datasets/NUDT'
segmentation_class_dir = os.path.join(voc_root, 'masks')  # mask 文件所在目录
image_sets_dir = os.path.join(voc_root, 'ImageSets')  # 保存 train.txt, val.txt, test.txt 的目录
...
# 划分比例
train_ratio = 0.5  # 70% 作为训练集
val_ratio = 0  # 20% 作为验证集
test_ratio = 0.5  # 10% 作为测试集
